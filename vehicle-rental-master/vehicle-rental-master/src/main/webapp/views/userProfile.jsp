...
<head>
    ...
    <style>
        ...
        body {
            ...
            padding-top: 2rem; /* Add top padding to the body */
            margin: 0;
        }
        ...
        input {
            ...
            display: inline-block; /* Align input and icon side by side */
        }
    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/home/profile" method="post">
            ...
            <div class="document-link">
                <label for="userLicense">Driver's License URL</label>
                <input type="text" id="userLicense" name="userLicense" value="${user.userLicense}" required>
                <c:choose>
                    <c:when test="${user.driverLicenseVerified}">
                        <i class="fas fa-check-circle verification-icon verified" title="Verified"></i> <!-- Green tick mark -->
                    </c:when>
                    <c:otherwise>
                        <i class="fas fa-times-circle verification-icon not-verified" title="Not Verified"></i> <!-- Red circle -->
                    </c:otherwise>
                </c:choose>
            </div>
            ...
            <!-- Aadhar Section -->
            <div class="document-link">
                <label for="userAadhar">Aadhar URL</label>
