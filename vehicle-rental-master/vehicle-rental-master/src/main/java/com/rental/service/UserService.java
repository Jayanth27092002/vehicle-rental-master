...
public class UserService {
    ...
    public List<User> getUsersWithUnverifiedDocuments() {
        return userRepository.findByDriverLicenseVerifiedFalseOrAadharVerifiedFalse();
    }

    public void verifyUserDocuments(String userId) {
        User user = userRepository.findById(userId).orElseThrow(() -> new RuntimeException("User not found"));
        user.setDriverLicenseVerified(true);
        user.setAadharVerified(true);
        userRepository.save(user);
    }
